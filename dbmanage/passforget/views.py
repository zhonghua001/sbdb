...
from dbmanage.myapp.tasks import sendmail_forget

# from dbmanage.myapp.form import Captcha
from dbmanage.mypro.settings import URL_FOR_PASSWD
from dbmanage.passforget.models import Passwd_forget
...
def pass_forget(request):
    try:
        ...
        record = Passwd_forget.objects.filter(vc_value=vc,username=username,is_valid=1,create_time__gte=timezone.now()-datetime.timedelta(minutes=30))[:1]
    except Exception,e:
        print e
