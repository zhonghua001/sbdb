...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"No data available in table",sInfo:"本页为_START_ - _END_ 条/共 _TOTAL_ 条记录",sInfoEmpty:"本页 0 条/ 共 0 条",sInfoFiltered:"(从 _MAX_ 条数据中过滤)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:" _MENU_ 条/页",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"搜索：",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有找到匹配记录"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
...
$(".back_oper").click(function(){
	var customer_id = $(this).attr("customer_id");
	var customer_oper = $(this).attr("customer_oper");
	$.post("",
		{
		  customer_id:customer_id,
		  customer_oper:customer_oper
		},
		function(status){
		  alert(status);
...
"function"===typeof define&&define.amd?define("datatables",["jquery"],O):"object"===typeof exports?O(require("jquery")):jQuery&&!jQuery.fn.dataTable&&O(jQuery)})(window,document);
